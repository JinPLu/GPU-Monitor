...
Authorized non-GPU remote work—including Git synchronization, file maintenance,
and read-only environment checks—does not require a ServerPilot lease, but it
still requires a current authorized endpoint. Advanced compatibility tools are
